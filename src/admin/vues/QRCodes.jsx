    ...
    <>
      ...
      {aImprimer && (
        <div className="planche-print" style={{ padding: 50, textAlign: 'center' }}>
          {/* Même logo que partout ailleurs dans l'application (cf. la sidebar admin). */}
          <img src="/logo.png" alt="5P STAR" style={{ width: 200, height: 'auto', margin: '0 auto', display: 'block' }} />
          ...
          <p style={{ fontSize: 23, fontWeight: 700, color: '#1E2A36' }}>Pointage des équipes 5P Star</p>
          {/* Consigne agrandie : elle doit rester lisible une fois la planche affichée au mur. */}
          <p style={{ fontSize: 20, lineHeight: 1.45, maxWidth: 520, margin: '12px auto', color: '#5C6B7A' }}>
