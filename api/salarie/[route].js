// Routeur unique /api/salarie/* — regroupe les endpoints salariée en UNE fonction.
...
import regulariser from '../_lib/routes-salarie/regulariser.js';

const ROUTES = { accueil, scan, missions, calendrier, heures, regulariser };
