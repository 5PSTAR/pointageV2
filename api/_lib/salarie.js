...
import { T, lister, F, lien, echapper } from './airtable.js';
...
/**
 * Ne garde que les enregistrements réellement liés à cette salariée.
 * Une formule Airtable ne peut comparer un lien qu'à son champ principal,
 * c'est-à-dire au nom ; ce second passage sur l'identifiant écarte les
 * homonymes, qui liraient — ou clôtureraient — la mission d'une collègue.
 */
export const siennes = (enregistrements, salarie, champ = 'Salarié') =>
  enregistrements.filter((e) => lien(e, champ) === salarie.id);
