...
import { T, lister, creer, modifier, referentiels, lirePointage, F, lien, aujourdhuiParis, echapper, envoyerErreur } from '../airtable.js';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const { contenu, prestationId, _source } = req.body || {};
    ...
    if (ouverts.length) {
      ...
      const champsDep = { 'Heure de départ': maintenant, 'Statut': 'Terminée' };
